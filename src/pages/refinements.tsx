          ...
          <div className="space-y-8">
            {[1, 2, 3].map((i) => (
              <div key={i} className="space-y-4">
                <Skeleton className="h-8 w-48 mb-4 bg-gray-300 dark:bg-gray-900" />
                <div className="p-6 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
                  <div className="space-y-6">
                    <div>
                      <Skeleton className="h-4 w-32 mb-3 bg-gray-300 dark:bg-gray-900" />
                      <div className="pl-4 border-l-2 border-gray-100 dark:border-gray-700">
                        ...
                        <Skeleton className="h-4 w-24 mt-2 bg-gray-200 dark:bg-gray-700" />
                      </div>
                    </div>
                    <div>
                      <Skeleton className="h-4 w-32 mb-3 bg-gray-300 dark:bg-gray-900" />
